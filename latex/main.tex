...
\begin{itemize}
  \item \verb|p|: Número de retardos autorregresivos (AR) (número de datos del pasado $x_{p}$ usados para modelar el valor actual).
  \item \verb|d|: Número de diferencias necesarias para hacer la serie estacionaria (es decir con media y varianza constantes).
  \item \verb|q|: Número de términos de media móvil (MA) (número de errores $\epsilon_{q}$ considerados para modelar el valor actual).
\end{itemize}

a los datos del glaciar Jakobshavn.

Los parámetros del modelo se obtuvieron usando la función auto\_arima.
